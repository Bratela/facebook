...
require 'facebook/error/identity_map_key_error'
...
module Facebook
  class Base
    ...
    # return [Facebook::IdentityMap]
    def self.identity_map
      return unless Facebook.identity_map
      @identity_map = Facebook.identity_map.new unless defined?(@identity_map) && @identity_map.class == Facebook.identity_map
      @identity_map
    end
    ...
    def self.fetch(attrs)
      ...
      raise Facebook::Error::IdentityMapKeyError, "key not found"
    end
